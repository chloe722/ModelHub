...
public class AboutPagePresenter implements AboutPageContract.Presenter {
    ...
    public final static String ABOUT_JEEVA = "ABOUTJEEVA";
    ...
    private AboutJeevaFragment mAboutJeevaFragment;
    ...
    public void transToItemsMain() {
        ...
        if(mAboutJeevaFragment != null) transaction.hide(mAboutJeevaFragment);
    ...
    public void transToAbout() {
        ...
        mAboutJeevaFragment = AboutJeevaFragment.newInstance();
        ...
        transaction.add(R.id.aboutpage_content_container, mAboutJeevaFragment, ABOUT_JEEVA);
        transaction.commit();
        mAboutPageView.showAboutUi();

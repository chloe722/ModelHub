...
import thhsu.chloe.ModelHub.SavedJobs.SavedJobContract;
    ...
    public class SavedJobsItemViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View v) {
            ...
            if(v.getId() == R.id.saved_job_savedJob_icn_btn){
                //setSOLite data here
//                if(ModelHub.getModelHubSQLHelper().getSavedJob(mJobs.get(getAdapterPosition()).getId())){
...
//                    Log.d("Chloe", "is saved: " +ModelHub.getModelHubSQLHelper().getSavedJob(mJobs.get(getAdapterPosition()).getId()) );

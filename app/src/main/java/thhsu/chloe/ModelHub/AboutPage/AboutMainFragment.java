...
public class AboutMainFragment extends Fragment implements View.OnClickListener{
    Button mModelHubBtn, mTermOfUseBtn, mPrivacyPolicyBtn, mContactBtn;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mModelHubBtn = (Button) view.findViewById(R.id.about_page_about_modelhub_btn);
        ...
        mModelHubBtn.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.about_page_about_modelhub_btn:
